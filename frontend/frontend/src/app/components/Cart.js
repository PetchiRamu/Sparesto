          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-teal-100/60">
            <div className="md:col-span-4 space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed max-w-sm">
                Global specialists in high-performance wind turbine spare parts
                and refurbishment services for industrial energy grids.
              </p>
            </div>
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-2 text-xs">
                ...
                <li>
                  <Link href="/e-auction">E-Auction</Link>
                </li>
                <li>
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-2 text-xs">
                <li>
                  <Link href="/services">Spare Parts Services</Link>
                </li>
                <li>
            ...
            <div className="md:col-span-4 space-y-3">
              ...
              <div className="flex mt-2 max-w-md shadow-sm">
                <input
                  ...
                  className="w-full px-4 py-2 text-xs bg-white border border-slate-200 rounded-l-md"
                />

                <button className="bg-teal-900 hover:bg-teal-800 text-white font-semibold text-xs px-5 rounded-r-md">
                  Join
                </button>
              </div>
            </div>
